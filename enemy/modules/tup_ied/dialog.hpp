...
class tup_ied_DisarmPrompt
{
	...
	class Controls
	{
				class pdbTextbox: RscTUP_IEDStructuredText
				{
					idc = 1100;
					text = "The IED device appears to have a wiring configuration that is new to you. Two wires connect to the detonator, do you cut the red wire or the blue wire?";
				...
				class pdbButtonYes: RscTUP_IEDButton
				{
					idc = 1600;
					text = "Red Wire";
				...
				class pdb_ButtonNo: RscTUP_IEDButton
				{
					idc = 1601;
					text = "Blue Wire";
